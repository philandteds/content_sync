    ...
    public function getVersion() {
        if( isset( $this->cache['version'] ) === false ) {
            $this->cache['version'] = eZContentObjectVersion::fetchVersion(
                    $this->attribute( 'object_version' ), $this->attribute( 'object_id' )
            );
        }
